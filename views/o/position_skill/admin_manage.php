...
<?php $this->renderPartial('/o/position_skill/_search', array(
	'model'=>$model,
)); ?>
</div>
<?php //end.Search ?>
...
<div class="grid-form">
<?php $this->renderPartial('/o/position_skill/_option_form', array(
	'model'=>$model,
)); ?>
</div>
<?php //end.Grid Option ?>

<div id="partial-ipedia-position-skill">
	<?php //begin.Messages ?>
	<div id="ajax-message">
	<?php
