...
<?php $this->renderPartial('/o/company_industry/_search', array(
	'model'=>$model,
)); ?>
</div>
<?php //end.Search ?>
...
<div class="grid-form">
<?php $this->renderPartial('/o/company_industry/_option_form', array(
	'model'=>$model,
)); ?>
</div>
<?php //end.Grid Option ?>

<div id="partial-ipedia-company-industry">
	<?php //begin.Messages ?>
	<div id="ajax-message">
	<?php
	...
	<div class="boxed">
		...
		<?php 
			...
			$this->widget('application.libraries.yii-traits.system.OGridView', array(
				'id'=>'ipedia-company-industry-grid',
