...
class ViewIpediaOrganizations extends CActiveRecord
{
	 ...
	 * @return ViewIpediaOrganizations the static model class
	 */
	...
	{
		return '_view_ipedia_organizations';
	}
	...
	public function search()
	{
		...
		if(!Yii::app()->getRequest()->getParam('ViewIpediaOrganizations_sort'))
