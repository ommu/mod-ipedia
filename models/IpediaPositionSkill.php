...
class IpediaPositionSkill extends CActiveRecord
{
	...
	public function search()
	{
		...
		if(Yii::app()->getRequest()->getParam('skill'))
			$criteria->compare('t.skill_id', Yii::app()->getRequest()->getParam('skill'));
		else
		...
		if(!Yii::app()->getRequest()->getParam('IpediaPositionSkill_sort'))
