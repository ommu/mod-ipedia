 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_ipedia_setting".
 *
 * The followings are the available columns in table 'ommu_ipedia_setting':
 * @property integer $id
 ...
 */
class IpediaSetting extends CActiveRecord
{
	use GridViewTrait;
	 ...
	 * @return IpediaSetting the static model class
	 */
	...
	public function search()
	{
		...
		if(!Yii::app()->getRequest()->getParam('IpediaSetting_sort'))
