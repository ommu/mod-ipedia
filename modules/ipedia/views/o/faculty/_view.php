...
<div class="view">
	...
	<?php echo CHtml::encode($data->another_id); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('faculty_desc')); ?>:</b>
	<?php echo CHtml::encode($data->faculty_desc); ?>
	<br />
