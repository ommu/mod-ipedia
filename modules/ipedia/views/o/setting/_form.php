	...
	<div class="clearfix">
		...
		<div class="desc">
			...
			if($model->isNewRecord || (!$model->isNewRecord && $model->license == ''))
				$model->license = IpediaSetting::getLicense();
	...
	<div class="clearfix">
		...
		<div class="desc">
			...
			<?php echo $form->radioButtonList($model, 'permission', array(
				1 => Yii::t('phrase', 'Yes, the public can view ipedia unless they are made private.'),
				0 => Yii::t('phrase', 'No, the public cannot view ipedia.'),
			)); ?>
