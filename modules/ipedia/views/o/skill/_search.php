...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<ul>
		<li>
			<?php echo $model->getAttributeLabel('skill_id'); ?><br/>
			<?php echo $form->textField($model,'skill_id',array('size'=>11,'maxlength'=>11)); ?>
		</li>
		...
		<li>
			<?php echo $model->getAttributeLabel('skill_desc'); ?><br/>
			<?php echo $form->textArea($model,'skill_desc',array('rows'=>6, 'cols'=>50)); ?>
		</li>
