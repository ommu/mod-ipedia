...
<?php $this->widget('application.components.system.FDetailView', array(
	...
	'attributes'=>array(
		array(
			...
			//'value'=>$model->skill_id != '' ? $model->skill_id : '-',
		),
		array(
			'name'=>'publish',
		...
		array(
			...
			//'value'=>$model->skill_desc != '' ? CHtml::link($model->skill_desc, Yii::app()->request->baseUrl.'/public/visit/'.$model->skill_desc, array('target' => '_blank')) : '-',
			'type'=>'raw',
		),
		array(
			'name'=>'creation_date',
