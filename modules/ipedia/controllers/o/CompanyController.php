...
class CompanyController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		$setting = IpediaCompanies::model()->findByPk(1,array(
		...
		$dataProvider = new CActiveDataProvider('IpediaCompanies', array(
			'criteria'=>$criteria,
			'pagination'=>array(
				'pageSize'=>10,
			),
		...
		$this->pageTitle = Yii::t('phrase', 'Ipedia Companies');
	...
	public function actionAdd() 
	{
		...
		if(isset($_POST['IpediaCompanies'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'IpediaCompanies success created.'));
	...
	public function actionEdit($id) 
	{
		...
		if(isset($_POST['IpediaCompanies'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'IpediaCompanies success updated.'));
					//$this->redirect(array('view','id'=>$model->company_id));
					$this->redirect(array('manage'));
				}
			}
