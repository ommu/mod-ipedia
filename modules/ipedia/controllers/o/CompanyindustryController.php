...
class CompanyindustryController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		$setting = IpediaCompanyIndustry::model()->findByPk(1,array(
		...
		$dataProvider = new CActiveDataProvider('IpediaCompanyIndustry', array(
			'criteria'=>$criteria,
			'pagination'=>array(
				'pageSize'=>10,
			),
		...
		$this->pageTitle = Yii::t('phrase', 'Ipedia Company Industries');
		$this->pageDescription = $setting->meta_description;
		$this->pageMeta = $setting->meta_keyword;
		$this->render('/o/company_industry/front_index',array(
	...
	public function actionView($id) 
	{
		...
		$this->pageMeta = $setting->meta_keyword;
		$this->render('/o/company_industry/front_view',array(
			'model'=>$model,
		));
		/*
	...
	public function actionAdd() 
	{
		...
		if(isset($_POST['IpediaCompanyIndustry'])) {
			$model->attributes=$_POST['IpediaCompanyIndustry'];
				...
				if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
					if($model->save()) {
						echo CJSON::encode(array(
							...
							'msg' => '<div class="errorSummary success"><strong>'.Yii::t('phrase', 'IpediaCompanyIndustry success created.').'</strong></div>',
						));
					} else {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'IpediaCompanyIndustry success created.'));
		...
		$this->pageTitle = Yii::t('phrase', 'Create Ipedia Company Industries');
		$this->pageDescription = '';
		$this->pageMeta = '';
		$this->render('/o/company_industry/admin_add',array(
			'model'=>$model,
		));
	}
	...
	public function actionEdit($id) 
	{
		...
		if(isset($_POST['IpediaCompanyIndustry'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'IpediaCompanyIndustry success updated.'));
					//$this->redirect(array('view','id'=>$model->id));
					$this->redirect(array('manage'));
				}
			}
		...
		$this->pageTitle = Yii::t('phrase', 'Update Ipedia Company Industries');
		$this->pageDescription = '';
		$this->pageMeta = '';
		$this->render('/o/company_industry/admin_edit',array(
			'model'=>$model,
		));
	}
	...
	public function actionHeadline($id) 
	{
		...
		if(Yii::app()->request->isPostRequest) {
			...
			$this->pageDescription = '';
			$this->pageMeta = '';
			$this->render('/o/company_industry/admin_headline');
		}
	}
