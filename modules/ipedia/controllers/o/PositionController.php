...
class PositionController extends Controller
{
	...
	public function actionIndex() 
	{
		...
		$setting = IpediaPositions::model()->findByPk(1,array(
		...
		$dataProvider = new CActiveDataProvider('IpediaPositions', array(
			'criteria'=>$criteria,
			'pagination'=>array(
				'pageSize'=>10,
			),
		...
		$this->pageTitle = Yii::t('phrase', 'Ipedia Positions');
	...
	public function actionAdd() 
	{
		...
		if(isset($_POST['IpediaPositions'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'IpediaPositions success created.'));
	...
	public function actionEdit($id) 
	{
		...
		if(isset($_POST['IpediaPositions'])) {
			...
			*/
			...
			if(isset($_GET['enablesave']) && $_GET['enablesave'] == 1) {
				if($model->save()) {
					Yii::app()->user->setFlash('success', Yii::t('phrase', 'IpediaPositions success updated.'));
					//$this->redirect(array('view','id'=>$model->position_id));
					$this->redirect(array('manage'));
				}
			}
