 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "_view_ipedia_major_industry".
 *
 * The followings are the available columns in table '_view_ipedia_major_industry':
 * @property string $major_id
 * @property string $industries
 * @property string $industry_all
 */
class ViewIpediaMajorIndustry extends CActiveRecord
{
	 ...
	 * @return ViewIpediaMajorIndustry the static model class
	 */
	...
	public function rules()
	{
		...
		return array(
			...
			array('major_id, industries, industry_all', 'safe', 'on'=>'search'),
		);
	}
