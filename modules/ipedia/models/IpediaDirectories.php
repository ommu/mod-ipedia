 ...
 * --------------------------------------------------------------------------------------
 *
 * This is the model class for table "ommu_ipedia_directories".
 *
 * The followings are the available columns in table 'ommu_ipedia_directories':
...
class IpediaDirectories extends CActiveRecord
{
	 ...
	 * @return IpediaDirectories the static model class
	 */
	...
	{
		return 'ommu_ipedia_directories';
	}
	...
	public function rules()
	{
		...
		return array(
			array('directory_name, creation_date, creation_id, modified_id', 'required'),
			array('publish', 'numerical', 'integerOnly'=>true),
			array('creation_id, modified_id', 'length', 'max'=>11),
			array('modified_date', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('directory_id, publish, directory_name, creation_date, creation_id, modified_date, modified_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'ommuIpediaCompanies_relation' => array(self::HAS_MANY, 'OmmuIpediaCompanies', 'directory_id'),
			'ommuIpediaDirectoryLocations_relation' => array(self::HAS_MANY, 'OmmuIpediaDirectoryLocation', 'directory_id'),
			'ommuIpediaOrganizations_relation' => array(self::HAS_MANY, 'OmmuIpediaOrganizations', 'directory_id'),
			'ommuIpediaUniversities_relation' => array(self::HAS_MANY, 'OmmuIpediaUniversities', 'directory_id'),
		);
	}
