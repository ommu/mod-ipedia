...
class IpediaCompanyIndustry extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('company_id, industry_id, creation_date, creation_id, modified_id', 'required'),
			array('publish', 'numerical', 'integerOnly'=>true),
			array('company_id, industry_id, creation_id, modified_id', 'length', 'max'=>11),
			array('modified_date', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, publish, company_id, industry_id, creation_date, creation_id, modified_date, modified_id', 'safe', 'on'=>'search'),
		);
	}
	...
	public function search()
	{
		...
		if(!isset($_GET['IpediaCompanyIndustry_sort']))
